...
ESP-IDF firmware for ESP32-C3 and ESP32-S3, an embedded HTML/CSS/JavaScript management and reading interface, Python pack tooling, a browser flasher, and a native Android app built with Kotlin and Jetpack Compose.
