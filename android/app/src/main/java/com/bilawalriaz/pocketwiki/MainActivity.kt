package com.bilawalriaz.pocketwiki
...
import com.bilawalriaz.pocketwiki.device.ApConnectMonitor
import com.bilawalriaz.pocketwiki.device.BleProvisioner
import com.bilawalriaz.pocketwiki.device.PackCatalog
import com.bilawalriaz.pocketwiki.device.PhoneWifi
import com.bilawalriaz.pocketwiki.device.WifiScanner
import com.bilawalriaz.pocketwiki.theme.PocketWikiTheme
import com.bilawalriaz.pocketwiki.ui.main.MainScreen
import com.bilawalriaz.pocketwiki.ui.main.OnboardingScreen
import com.bilawalriaz.pocketwiki.ui.main.SetupPermission
import com.bilawalriaz.pocketwiki.ui.main.SetupStep
import com.bilawalriaz.pocketwiki.ui.main.effectsMotion
        ...
        AnimatedContent(
          ...
          if (!onboarded) {
            ...
            MainScreen(
              ...
              snackbarHost = snackbarHost,
              onConnect = ble::ensureConnect,
              onCancelInstall = ble::cancelInstalls,
              onOpenUrl = ::openUrl,
