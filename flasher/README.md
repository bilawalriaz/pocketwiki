...
the app. Tagging a release builds a ready-to-run Apple-silicon build and
publishes it as an asset of the GitHub Release.
...
publishes everything, the firmware zips for both boards plus the app zips, as
